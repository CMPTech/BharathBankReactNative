...
function StarselectedIcon({ width, height, color1, color2 }) {
  return (
    ...
    >
      <Path
        d="M22.963 8.912c-.1-.4-.399-.599-.798-.699l-6.378-.898-2.89-5.79c-.299-.7-1.495-.7-1.794 0l-2.89 5.69-6.279.998c-.398 0-.697.3-.897.7-.1.399 0 .798.3.998l4.584 4.492-1.097 6.39c-.1.4.1.799.4.998.298.2.697.3 1.095.1L12 18.896l5.68 2.995h.499c.2 0 .399-.1.598-.2.299-.2.498-.598.398-.998l-1.096-6.39 4.585-4.492c.299-.2.398-.6.299-.899Z"
        fill="#fff"
      />
    </Mask>
    <G mask="url(#a)">
...
export default React.memo(StarselectedIcon)
